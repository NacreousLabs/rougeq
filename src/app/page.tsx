  ...
  return (
    <Container size="lg">
      ...
      <div className="py-8 text-center">
        <h1 className="font-display text-5xl font-bold uppercase italic tracking-tight text-rouge dark:text-bombers-gold">
          RougeQ
        </h1>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <section>
          <div className="mb-2 flex items-center justify-between">
            ...
            <Link href="/power" className="text-xs text-rouge hover:underline dark:text-bombers-gold">Full table →</Link>
          </div>
          <div className="divide-y divide-zinc-100 rounded-lg border border-zinc-200 dark:divide-zinc-800 dark:border-zinc-800">
            {top.map((r, i) => (
      ...
      <div className="mt-8 flex flex-wrap gap-3 text-sm">
        <Link href="/standings" className="rounded-md bg-rouge px-4 py-2 font-medium text-white hover:opacity-90 dark:bg-bombers-gold dark:text-rouge">Standings & Projections</Link>
