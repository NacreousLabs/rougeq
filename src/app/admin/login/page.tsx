  ...
  return (
    <div className="mx-auto w-full max-w-sm flex-1 px-6 py-24">
      ...
      >
        <button
          type="submit"
          className="flex w-full items-center justify-center gap-2 rounded-md bg-bombers-navy px-4 py-2 font-display text-sm font-semibold uppercase tracking-wide text-white hover:bg-bombers-blue"
        >
